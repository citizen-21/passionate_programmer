...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM customer WHERE cust_email='$email' AND password='$password'";
      ...
      <div class="form">
        ...
        <div class="contact-form" >
          ...
          <form action="" method="POST" autocomplete="off" style="margin-top: 150px;">
            ...
            <div class="input-container">
              <input type="password" name="password" placeholder="password" value="<?php echo $password; ?>" class="input" />
            </div>
